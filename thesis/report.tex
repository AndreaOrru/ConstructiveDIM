	...
	\chapter{Main Result}
		\section{Analysis and Design}
			...
			\subsection{Criteria for adding neurons}
				One of the main decisions to be made when designing a constructive algorithm is under what conditions should new neurons be added to the network. An analysis of the shape of a typical curve describing the overall error in the network over time will help understand the issue.
				
				At first, I experimented with a very simple criterion: simply add a neuron if the overall average error, measured among all the elements of $e$ and for one epoch, is higher than a certain threshold. Results were not great and the network tended to grow bigger 
