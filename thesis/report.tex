	...
	\chapter{Main Result}
		\section{Analysis and Design}
			...
			\subsection{Stopping criteria}
				An additional advantage that the designed algorithm has compared to the original one is the presence of a \emph{stopping criterion} based on the error of the network. In fact, I found experimentally that when the error definitely goes under a certain threshold, the network most likely discovered all the image components. In that case, further training is deemed unnecessary and the algorithm can stop.
