	...
	\chapter{Main Result}
		\section{Analysis and Design}
			...
			\subsection{Analysis of the current algorithm}
				...
				Another important point is: what factor should drive the decision of adding neurons to the network? The way the model is engineered, the values of the error-detecting neurons 
			...
			\subsection{Classes of constructive algorithms}
				...
				Even though these algorithm were conceived for simple feed forward neural networks, they have been proven successful even when applied to recurrent neural networks \cite{ash1989dynamic}.
				
			\subsection{Criteria for adding neurons}
				One of the main decisions to be made when designing a constructive algorithm is under what conditions should new neurons be added to the network. To better understand 
