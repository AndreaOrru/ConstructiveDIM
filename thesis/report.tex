	...
	\begin{appendices}
		\chapter{Source Code}
			...
			\section{Constructive PC/BC--DIM}
				...
				\lstinputlisting{learn_bars_feedback.m}
				\lstinputlisting{Heaviside.m}
				\lstinputlisting{dim_activation.m}
				\lstinputlisting{dim_learn.m}
				\lstinputlisting{dim_learn_feedback.m}
				\lstinputlisting{highest_integer_factors.m}
				\lstinputlisting{hinton_plot.m}
				\lstinputlisting{pattern_bars.m}
				\lstinputlisting{plot_bars.m}
				\lstinputlisting{weight_initialisation_random.m}
	\end{appendices}
\end{document}
