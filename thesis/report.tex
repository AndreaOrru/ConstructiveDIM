	...
	\chapter{Main Result}
		\section{Analysis and Design}
			...
			\subsection{Analysis of the current algorithm}
				...
				A question which is important to answer is: what does tuning this parameter means in terms of image decomposition? As it is known from the literature \cite{spratling2014predictive}, the weights received by a single output neuron are contained in the respective row 
